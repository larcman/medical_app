...
ActiveRecord::Schema.define(version: 20170704190830) do
  ...
  create_table "evaluations", id: :string, default: -> { "get_uuid()" }, force: :cascade do |t|
    ...
    t.string   "qui_indice_aterosclerosis"
    t.string   "qui_apoa1"
    t.string   "qui_apob"
    t.string   "qui_tgoast"
    t.string   "qui_albumina"
    t.string   "lab_reuma_c3"
    t.string   "lab_reuma_c4"
    t.string   "lab_reuma_antipad3"
    t.string   "lab_reuma_antipad4"
    t.string   "lab_mol_dna"
    t.string   "lab_mol_rna"
    t.string   "lab_mol_mirna"
    t.string   "exp_fisica_tas"
    t.string   "exp_fisica_tad"
    t.string   "exp_fisica_tam"
    t.string   "dinam_der1a"
    t.string   "dinam_der2a"
    t.string   "dinam_der3a"
    t.string   "dinam_der4a"
    t.string   "dinam_izq1a"
    t.string   "dinam_izq2a"
    t.string   "dinam_izq3a"
    t.string   "dinam_izq4a"
    t.string   "reuma_nad"
    t.string   "reuma_nat"
    t.string   "reuma_eva_enfermedad"
    t.string   "reuma_eva_ddos"
    t.string   "reuma_eva_medico"
    t.string   "reuma_cdai"
    t.string   "reuma_sdai"
  end
